...
const questions = [
  ...
  function nQuestions() {
    ...
    const numberQuestions = document.getElementById('domanda');
    numberQuestions.innerText = "Choose the number of questions";
    const divScelte = document.getElementById('risposte');
  ...
  function getQuestion(shuffle) {
    ...
    const interval = setInterval(function () {
      ...
      //upp si aggiorna: prendiamo il tempo attuale e gli sottraiamo il tempo preso all'inizio
    ...
    }, 1000); //1000 is the time interval in milliseconds
