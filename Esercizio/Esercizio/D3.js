...
if (character.gender === "female"){
  ...
  femaleCharacters.push(characterTrait)
}
}
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  switch (character.eye_color) {
    case "blue": eyeColor.blue.push(character);
      break;
    case "yellow": eyeColor.yellow.push(character);
      break;
    case "brown": eyeColor.brown.push(character);
      break;
    case "red": eyeColor.red.push(character);
      break;
    case "blue_grey": eyeColor.blue_grey.push(character);
      break;
  }
}
